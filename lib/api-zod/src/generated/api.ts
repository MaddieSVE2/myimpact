...
export const GetImpactHistoryResponse = zod.object({
  ...
  streak: zod
    .object({
      ...
      longest: zod.number().int(),
      atRisk: zod.boolean(),
      weekStart: zod.string(),
      nextMilestone: zod.number().int().nullish(),
      lastAckedMilestone: zod.number().int(),
    })
    .optional(),
});
...
export const GetYearRolloverResponse = zod.object({
  ...
  priorYear: zod.number().int().nullish(),
...
export const ConfirmYearRolloverBody = zod.object({
  confirmedTemplateIds: zod.array(zod.number().int()),
});

export const ConfirmYearRolloverResponse = zod.object({
  entriesCreated: zod.number().int(),
  year: zod.number().int(),
});
...
export const GetAnnualRecapResponse = zod.object({
  ...
  categoriesCount: zod.number().int(),
  sdgsCount: zod.number().int(),
  topActivity: zod
    .union([
      zod.object({
        activityId: zod.string(),
  ...
  journalHighlight: zod
    ...
    .optional(),
  milestonesEarnedCount: zod.number().int(),
  firstRecordAt: zod.string().nullish(),
  lifetimeRecordCount: zod.number().int(),
...
export const LogRecurringOccurrenceResponse = zod.object({
  record: zod.object({
    ...
    kind: zod.string(),
    reportingYear: zod.number().int().nullish(),
    totalHours: zod.number(),
    totalValue: zod.number(),
  }),
  template: zod.object({
