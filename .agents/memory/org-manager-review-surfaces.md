...
**How to apply:**
- Any manager-facing per-record feature needs both surfaces: OrgPortal panels AND the OrgActivities table/endpoint. Approvals now also live at /org/approvals (shared VerificationQueue component) for full-tier managers.
- Manager navigation for full-tier orgs is the top Navbar items (Dashboard/Activities/Approvals/...); OrgSubNav.tsx is dead code — don't add new tabs there.
