  ...
  try {
    ...
    if (context) {
      ...
      if (context.interests?.includes("org_manager")) {
        ...
        contextParts.push("This user is asking as an individual about their own personal impact. Talk to them about their own activities, their own hours, and how they can describe what they personally contribute (for example on a CV, UCAS personal statement, job application, LinkedIn post, or DofE record). Do not frame answers around running, leading, or managing an organisation. Do not mention funders, trustees, the board, volunteer onboarding, the organisation dashboard, 'your volunteers', 'your charity', 'your organisation', or 'your members'. Do not suggest activities that imply the user is in charge of other volunteers (such as 'coordinate a group of volunteers', 'train your team', 'organise events for your charity'). If the user explicitly says in their message that they are asking on behalf of a charity, voluntary group, or organisation they manage, you may switch to organisation-manager framing for that message — otherwise keep everything firmly in the first person, focused on what THIS PERSON does and how THEY can describe it.");
      }
