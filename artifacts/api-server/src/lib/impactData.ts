...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    unit: "km_per_year",
    unitLabel: "km",
    friendlyQuestion: "Roughly how many kilometres do you travel by foot or bike each year instead of driving?",
    defaultQuantity: 500,
    valuePerUnit: 0.35,
  ...
  },
  {
    ...
    shortName: "Veterans breakfast clubs",
    category: "Community",
    proxy: "Impact of loneliness on well-being",
    proxyYear: "2021",
    unit: "session",
    unitLabel: "sessions",
    friendlyQuestion: "How many sessions do you help out at each year?",
    defaultQuantity: 12,
    valuePerUnit: 45.0,
    sdg: "Good Health and Well-Being",
    sdgColor: "#4C9F38",
    description: "Volunteering at breakfast or social clubs for veterans.",
  },
  {
    id: "youth_mentoring",
