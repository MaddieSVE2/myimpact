export default function HowItWorks() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg">
      ...
      <h2 className="absolute top-[16vh] left-[6vw] right-[8vw] font-body font-bold text-[5vw] leading-[1] tracking-tight text-text" style={{ textWrap: "balance" }}>
      ...
      <div className="absolute bottom-[10vh] left-[6vw] right-[6vw] grid grid-cols-3 gap-[2vw]">
        <div className="bg-card p-[3vw] rounded-2xl border border-text/8">
          <div className="flex items-center justify-between mb-[3vh]">
            <span className="font-body font-black text-[5vw] leading-none text-primary">
              01
            </span>
