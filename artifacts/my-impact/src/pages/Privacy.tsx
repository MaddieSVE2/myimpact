...
const SECTIONS: Section[] = [
  {
    ...
    content: (
      <>
        ...
        <p style={{ marginTop: 12 }}>If you have any questions about this policy or how we handle your data, please contact us at <a href="mailto:hello@myimpact.uk" style={{ color: "var(--brand-orange)", fontWeight: 600, textDecoration: "none" }}>hello@myimpact.uk</a>.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p style={{ marginTop: 12 }}>To exercise any of these rights, please contact us at <a href="mailto:hello@myimpact.uk" style={{ color: "var(--brand-orange)", fontWeight: 600, textDecoration: "none" }}>hello@myimpact.uk</a>. We will respond within 30 days.</p>
