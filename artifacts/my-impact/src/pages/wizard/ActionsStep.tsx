...
export default function ActionsStep() {
  ...
  const { location, interests, setLocation: setWizardLocation, toggleInterest, updateInput } = useWizard();
  ...
  const handleNext = () => {
    ...
    const description = localLocation
      ? `I live in ${localLocation} and care most about: ${interestLabels || 'making a positive difference'}.`
      : `I care most about: ${interestLabels || 'making a positive difference'}.`;
    updateInput({ description });
    setLocation("/wizard/activities");
  };

  const canProceed = localLocation.trim().length > 0 || interests.length > 0;
    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-xs text-muted-foreground mb-4">Select all that apply — we'll use this to personalise your activities and suggestions.</p>
