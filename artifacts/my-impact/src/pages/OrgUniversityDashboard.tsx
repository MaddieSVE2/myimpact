    ...
    <div className="min-h-screen bg-muted/20" data-testid="org-university-dashboard-root">
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-10">
        ...
        <SkillsBreakdownCard
          ...
          title="Top skills your students are building"
          description="Skills are inferred from the types of activities students log. The percentage shows the share of actively logging students building each skill, directly relevant to employability and personal statements."
          peopleNoun="students"
        />
